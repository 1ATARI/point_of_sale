        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-0 ml-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{trans('msite.clients')}}
                        </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{trans('msite.clients')}}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                    <div class="card card-statistics h-100">
                        ...
                        <div class="card-header" style="background-color:rgba(0,0,0,.03)">
                            <h5 class="modal-title"style="display: inline">{{trans('msite.clients')}} </h5>
                        ...
                        <div class="card-body">
                            @if($clients->count()>0)
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <th>@lang('msite.phone')</th>
                                    <th>@lang('msite.address')</th>

                                    <th>@lang('msite.add_order')</th>
                                    ...
                                    @foreach($clients as $index=>$client)
                                        <tr>
                                            ...
                                            @if(auth()->user()->hasPermission('orders_create'))
                                                <td><a href="{{route('dashboard.clients.orders.create', $client->id)}}" class="btn btn-primary btn-sm">@lang('msite.add_order')</a></td>
                                            @else
                                                <td><a href="#"  class="btn btn-primary btn-sm disabled">@lang('msite.add_order')</a></td>
                                            ...
                                            <td class="project-actions text-left">
                                                ...
                                                @if(auth()->user()->hasPermission('clients_delete'))
                                                        <button type="button" class="btn delete btn-danger btn-sm" href="#" data-toggle="modal" data-target="#delete{{$client->id}}">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p>@lang('msite.are_you_sure_delete') "{{$client->name}}"</p>
                                                                    </div>
